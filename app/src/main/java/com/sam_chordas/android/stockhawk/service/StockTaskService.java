...
public class StockTaskService extends GcmTaskService {
    ...
    public int onRunTask(TaskParams params) {
        ...
        if(params.getTag().equals(Constants.INIT) || params.getTag().equals(Constants.PERIODIC)) {
            isUpdate = true;
            initQueryCursor = mContext.getContentResolver().query(QuoteProvider.Quotes.CONTENT_URI, new String[]{"Distinct " + QuoteColumns.SYMBOL}, null, null, null);
        ...
        else if (params.getTag().equals(Constants.ADD_STOCK)) {
            isUpdate = false;
        ...
        if (urlStringBuilder != null) {
            ...
            try {
                ...
                //Toast.makeText(mContext,getString(R.string.error_result),Toast.LENGTH_LONG).show();
            }
        }
